...
public class Event_OnBlockPlace extends BaseEventNode {

    public static final String TYPE_ID = "event_on_block_place";

    @Override
    public NodeDef getDefaultDefinition() {
        return NodeDef.builder(TYPE_ID, NodeType.EVENT, Component.translatable("geometry_node.node.event_on_block_place"))
